...
webpackJsonpL2Dwidget([0], {
    131: function(t, i, e) {
        ...
        function v(t) {
            var i = t.touches[0];
            "touchstart" == t.type ? 1 == t.touches.length && T(i) : "touchmove" == t.type ? function(t) {
                var i = o.currCanvas.getBoundingClientRect(),
                    e = E(t.clientX - i.left),
                    r = A(t.clientY - i.top),
                    n = m({
                    ...
                    s = L(n.x - i.left),
                    _ = M(n.y - i.top);
                h.cDefine.DEBUG_MOUSE_LOG && console.log("followPointer onMouseMove device( x:" + t.clientX + " y:" + t.clientY + " ) view( x:" + s + " y:" + _ + ")"), y && (e, r, p.setPoint(s, _))
            }(i) : "touchend" == t.type && P()
        }
    ...
    132: function(t, i, e) {
        ...
        (function(t) {
            ...
            r._$0s = 1, r._$4s = 2, r._$42 = 0, r._$62 = function(t, i) {
                try {
                    ...
                    if (e = o._$ST(), o._$gr(e), e > G._$T7) {
                        t._$NP |= r._$4s;
                        throw new ht("_$gi _$C _$li , _$n0 _$_ version _$li ( SDK : " + G._$T7 + " < _$f0 : " + e + " )@_$SS#loadModel()\n")
                    }
                    var h = o._$nP();
                    if (e >= G._$s7) {
                        var $ = o._$9T(),
                    ...
                    if (1 == t.length) {
                        ...
                        for (l = 0; l < t.length; l++) {
                            ...
                            if (o == l) this.setPartsOpacity(p, n);
                                ...
                                var h, $ = this.getPartsOpacity(p);
                                (1 - (h = n < .5 ? -.5 * n / .5 + 1 : .5 * (1 - n) / .5)) * (1 - n) > .15 && (h = 1 - .15 / (1 - n)), $ > h && ($ = h), this.setPartsOpacity(p, $)
                            }
                        }
                    }
                else
            ...
            o.CHANNEL_COUNT = 4, o.RENDER_TEXTURE_USE_MIPMAP = !1, o.NOT_USED_FRAME = -100, o.prototype._$L7 = function() {
                ...
                for (var r = 0, n = 0; n < o.CHANNEL_COUNT; n++) {
                    ...
                    if (0 == s);
                        ...
                        (l = this.clipContextList[r++]).layoutChannelNo = n, l.layoutBounds.x = 0, l.layoutBounds.y = 0, l.layoutBounds.width = 1, l.layoutBounds.height = 1
                    } else if (2 == s)
                        for (var a = 0; a < s; a++) {
                            var h = 0;
                            $ = ~~($ = a % 2);
                            (l = this.clipContextList[r++]).layoutChannelNo = n, l.layoutBounds.x = .5 * $, l.layoutBounds.y = 0, l.layoutBounds.width = .5, l.layoutBounds.height = 1
                        } else if (s <= 4)
                            for (a = 0; a < s; a++) {
                                $ = ~~($ = a % 2), h = ~~(h = a / 2);
                                (l = this.clipContextList[r++]).layoutChannelNo = n, l.layoutBounds.x = .5 * $, l.layoutBounds.y = .5 * h, l.layoutBounds.width = .5, l.layoutBounds.height = .5
                            } else if (s <= 9)
                                for (a = 0; a < s; a++) {
                                    var $;
                                    $ = ~~($ = a % 3), h = ~~(h = a / 3);
                                    var l;
                                    (l = this.clipContextList[r++]).layoutChannelNo = n, l.layoutBounds.x = $ / 3, l.layoutBounds.y = h / 3, l.layoutBounds.width = 1 / 3, l.layoutBounds.height = 1 / 3
            ...
            }, L.prototype.preDraw = function(t, i, e) {}, L.prototype.draw = function(t, i, e) {}, L.prototype.getType = function() {}, L.prototype._$B2 = function(t, i, e) {};
                ...
                if (e._$hS(!0), this._$32()) {
                    ...
                    if (e._$8r == A._$ur && (e._$8r = t.getBaseDataIndex(r)), e._$8r < 0) _t._$so && _._$li("_$L _$0P _$G :: %s", r), e._$hS(!1);
                        ...
                        if (null != o) {
                            ...
                            var a = z._$io;
                            a[0] = 0, a[1] = -.1;
                            n._$GT().getType() == A._$c2 ? a[1] = -10 : a[1] = -.1;
                            var h = z._$0o;
            ...
            Z.prototype = new A, Z._$gT = new Array, Z.prototype._$zP = function() {
            ...
            _t._$2s = "2.1.00_1", _t._$Kr = 201001e3, _t._$sP = !0, _t._$so = !0, _t._$cb = !1, _t._$3T = !0, _t._$Ts = !0, _t._$fb = !0, _t._$ts = !0, _t.L2D_DEFORMER_EXTEND = !0, _t._$Wb = !1, _t._$yr = !1, _t._$Zs = !1, _t.L2D_NO_ERROR = 0, _t._$i7 = 1e3, _t._$9s = 1001, _t._$es = 1100, _t._$r7 = 2e3, _t._$07 = 2001, _t._$b7 = 2002, _t._$H7 = 4e3, _t.L2D_COLOR_BLEND_MODE_MULT = 0, _t.L2D_COLOR_BLEND_MODE_ADD = 1, _t.L2D_COLOR_BLEND_MODE_INTERPOLATE = 2, _t._$6b = !0, _t._$cT = 0, _t.clippingMaskBufferSize = 256, _t.glContext = new Array, _t.frameBuffers = new Array, _t.fTexture = new Array, _t.IGNORE_CLIP = !1, _t.IGNORE_EXPAND = !1, _t.EXPAND_W = 2, _t.USE_ADJUST_TRANSLATION = !0, _t.USE_CANVAS_TRANSFORM = !0, _t.USE_CACHED_POLYGON_IMAGE = !1, _t.DEBUG_DATA = {}, _t.PROFILE_IOS_SPEED = {
                ...
                for (var e in t) _t[e] = t[e], i && console.log("  [" + e + "] = " + t[e])
            }, _t.init = function() {
                if (_t._$6b) {
            ...
            $t.prototype = new W, $t._$42 = 0, $t._$Os = 30, $t._$ms = 0, $t._$ns = 1, $t._$_s = 2, $t._$gT = new Array, $t.prototype._$_S = function(t) {
                ...
                var i = new lt(this),
                    e = this._$d0 * B._$No,
                    r = this._$32();
                null != i._$Cr && (i._$Cr = null), i._$Cr = new Float32Array(e), null != i._$hr && (i._$hr = null), i._$hr = r ? new Float32Array(e) : null;
                switch (B._$do) {
                    default:
                    case B._$Ms:
                        if (B._$Ls)
            ...
            dt.prototype = new M, dt._$9r = function(t) {
                ...
                if (!(n < .01 && null == this.clipBufPre_clipContextMask)) {
                    ...
                    if (null != this.clipBufPre_clipContextMask) {
                        ...
                        a.uniform4f(this.u_baseColor_Loc, 2 * f.x - 1, 2 * f.y - 1, 2 * f._$EL() - 1, 2 * f._$5T() - 1), a.uniform1i(this.u_maskFlag_Loc, !0)
                        ...
                        a.uniform4f(this.u_channelFlag_Loc_Off, c.r, c.g, c.b, c.a), a.uniform4f(this.u_baseColor_Loc_Off, h, $, l, u)
                    ...
                    var g, y, d, m;
                    if (null != this.clipBufPre_clipContextMask) g = a.ONE, y = a.ONE_MINUS_SRC_ALPHA, d = a.ONE, m = a.ONE_MINUS_SRC_ALPHA;
                    else switch (s) {
                        case $t._$ms:
                    ...
                    a.blendEquationSeparate(a.FUNC_ADD, a.FUNC_ADD), a.blendFuncSeparate(g, y, d, m), this.anisotropyExt && a.texParameteri(a.TEXTURE_2D, this.anisotropyExt.TEXTURE_MAX_ANISOTROPY_EXT, this.maxAnisotropy);
                    var T = e.length;
            ...
            Mt._$W2 = 0, Mt.SYSTEM_INFO = null, Mt.USER_AGENT = navigator.userAgent, Mt.isIPhone = function() {
                ...
                var e, r = Mt.SYSTEM_INFO = {
                    userAgent: t
                };
                if ((e = t.indexOf("iPhone OS ")) >= 0) r.os = "iPhone", r._isIPhone = !0, r.version = i(t, e + "iPhone OS ".length);
                else if ((e = t.indexOf("iPad")) >= 0) {
                    if ((e = t.indexOf("CPU OS")) < 0) return void _._$li(" err : " + t + " @UtHtml5.setup()");
                    r.os = "iPad", r._isIPad = !0, r.version = i(t, e + "CPU OS ".length)
                } else(e = t.indexOf("Android")) >= 0 ? (r.os = "Android", r._isAndroid = !0, r.version = i(t, e + "Android ".length)) : (r.os = "-", r.version = -1)
            }, _t.init();
            e = !1;
    ...
    133: function(t, i, e) {
        ...
        o.prototype.getModelMatrix = function() {
            ...
            e.loadLive2DModel(t, function(t) {
                ...
                0 == r.Live2D.getError() ? (o.modelMatrix = new l(o.live2DModel.getCanvasWidth(), o.live2DModel.getCanvasHeight()), o.modelMatrix.setWidth(2), o.modelMatrix.setCenterPosition(0, 0), i(o.live2DModel)) : console.error("Error : Failed to loadModelData().")
            })
        ...
        s.prototype = new r.AMotion, s.EXPRESSION_DEFAULT = "DEFAULT", s.TYPE_SET = 0, s.TYPE_ADD = 1, s.TYPE_MULT = 2, s.loadJson = function(t) {
            ...
            for (var n = 0; n < o; n++) {
                ...
                if ((l = "add" === u ? s.TYPE_ADD : "mult" === u ? s.TYPE_MULT : "set" === u ? s.TYPE_SET : s.TYPE_ADD) == s.TYPE_ADD) {
