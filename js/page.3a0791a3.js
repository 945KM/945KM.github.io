parcelRequire = function(e, r, t, n) {
    ...
    "Bb20": [function(require, module, exports) {
        ...
        function e() {
            var e = ["希望能成为有趣的人", "给时光以生命<br>给岁月以文明", "我是肥猫，请多指教", "凡心所向，素履所往<br>生如逆旅，一苇以航", "永远屈服于温柔", "纵有千古，横有八荒<br>前途似海，来日方长", "平凡的日常正奇迹的发生着", "要等时间嘉许<br>等春风得意", "请成为永远疯狂永远浪漫永远清澈的存在", "而风声吹到这<br>已不需要释怀", "搞事！搞事！搞事！", "祝眉目舒展<br>顺问冬安<br>一心无累<br>四季良辰", "知命不惧<br>日日自新", "愿你以渺小启程<br>以伟大结束<br>在星辰大海的征途中<br>遇到那个最想要的自己", "岁岁年年<br>万喜万般宜", "没有一个冬天不可逾越<br>没有一个春天不会来临"],
                i = o(0, e.length - 1);
            t("#slogan").html(e[i])
        }
